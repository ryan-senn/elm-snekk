...
{
	if (region.a2.aw === region.bj.aw)
	{
		return 'on line ' + region.a2.aw;
	}
	return 'on lines ' + region.a2.aw + ' through ' + region.bj.aw;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b2: 'hidden', as: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b2: 'mozHidden', as: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b2: 'msHidden', as: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b2: 'webkitHidden', as: 'webkitvisibilitychange' }
		: { b2: 'hidden', as: 'visibilitychange' };
}
...
var author$project$Model$NotStarted = {$: 0};
var author$project$Model$initialModel = {bo: author$project$Model$NotStarted, bp: 0};
var author$project$Direction$East = 1;
var author$project$Direction$North = 0;
var author$project$Direction$South = 2;
var author$project$Direction$West = 3;
...
var author$project$Direction$decodeDirection = function (key) {
	switch (key) {
		...
		default:
			return elm$json$Json$Decode$fail('Not a valid Direction key.');
	}
};
...
var author$project$Direction$decoder = A2(
	...
	author$project$Direction$decodeDirection,
	A2(elm$json$Json$Decode$field, 'key', elm$json$Json$Decode$string));
var author$project$Msg$SetDirection = function (a) {
	return {$: 3, a: a};
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bn: fragment, bq: host, bz: path, bB: port_, bE: protocol, bF: query};
	});
...
var author$project$Subs$setDirection = function (gameState) {
	if (gameState.$ === 2) {
		return elm$browser$Browser$Events$onKeyDown(
			A2(elm$json$Json$Decode$map, author$project$Msg$SetDirection, author$project$Direction$decoder));
	} else {
		return elm$core$Platform$Sub$none;
	}
};
var author$project$Msg$StartGame = {$: 0};
...
var author$project$Subs$startGame = function (gameState) {
	switch (gameState.$) {
		case 0:
			return elm$browser$Browser$Events$onKeyDown(author$project$Subs$startGameDecoder);
		case 3:
			return elm$browser$Browser$Events$onKeyDown(author$project$Subs$startGameDecoder);
		default:
			return elm$core$Platform$Sub$none;
...
var author$project$Config$speed = 200;
var author$project$Msg$Tick = {$: 2};
...
var elm$time$Time$State = F2(
	function (taggers, processes) {
		return {bD: processes, bM: taggers};
	});
...
var author$project$Subs$ticks = function (gameState) {
	if (gameState.$ === 2) {
		return A2(
			elm$time$Time$every,
			author$project$Config$speed,
...
var author$project$Subs$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Subs$ticks(model.bo),
				author$project$Subs$setDirection(model.bo),
				author$project$Subs$startGame(model.bo)
			]));
};
var author$project$Model$Loading = {$: 1};
var author$project$Model$Started = function (a) {
	return {$: 2, a: a};
};
var author$project$Msg$SetFood = function (a) {
	return {$: 1, a: a};
};
var author$project$Config$gridSize = 12;
...
var author$project$Snekk$initialSnekk = A2(
	mgold$elm_nonempty_list$List$Nonempty$Nonempty,
	A2(author$project$Coord$Coord, 3, author$project$Config$gridSize - 1),
	_List_fromArray(
		[
			A2(author$project$Coord$Coord, 2, author$project$Config$gridSize - 1),
			A2(author$project$Coord$Coord, 1, author$project$Config$gridSize - 1)
		]));
var author$project$Helpers$getSnekk = function (gameState) {
	if (gameState.$ === 2) {
		var gameModel = gameState.a;
		return gameModel.cg;
	} else {
		return author$project$Snekk$initialSnekk;
	}
};
...
var author$project$Update$foodGenerator = function (gameState) {
	return A2(
		...
		function (_n0) {
			...
			return A2(
				...
				A2(author$project$Coord$Coord, x, y),
				author$project$Helpers$getSnekk(gameState)) ? author$project$Update$foodGenerator(gameState) : elm$random$Random$constant(
				A2(author$project$Coord$Coord, x, y));
		},
		A2(
			elm$random$Random$pair,
			A2(elm$random$Random$int, 0, author$project$Config$gridSize),
			A2(elm$random$Random$int, 0, author$project$Config$gridSize)));
};
...
var author$project$Update$generateFood = function (gameState) {
	return A2(
		elm$random$Random$generate,
		author$project$Msg$SetFood,
		author$project$Update$foodGenerator(gameState));
};
var author$project$Direction$oppositeDirection = function (direction) {
	switch (direction) {
		case 0:
			return 2;
		case 1:
...
var author$project$Update$setDirection = F2(
	function (desiredDirection, gameModel) {
		return _Utils_eq(
			desiredDirection,
			author$project$Direction$oppositeDirection(gameModel.bv)) ? gameModel : _Utils_update(
			gameModel,
			{bi: desiredDirection});
	});
var author$project$Model$initialGameModel = function (foodCoord) {
	return {bi: 1, bm: foodCoord, bv: 1, cg: author$project$Snekk$initialSnekk};
};
var author$project$Update$setFood = F2(
	function (gameState, foodCoord) {
		if (gameState.$ === 2) {
			var gameModel = gameState.a;
			...
			return author$project$Model$initialGameModel(foodCoord);
		}
	});
var author$project$Config$isOutOfBoundaries = function (coord) {
	return (_Utils_cmp(coord.bS, author$project$Config$gridSize) > 0) || ((coord.bS < 0) || ((_Utils_cmp(coord.bR, author$project$Config$gridSize) > 0) || (coord.bR < 0)));
};
var author$project$Model$GameOver = function (a) {
	return {$: 3, a: a};
};
...
var mgold$elm_nonempty_list$List$Nonempty$pop = function (_n0) {
	var x = _n0.a;
	var xs = _n0.b;
	if (!xs.b) {
...
var mgold$elm_nonempty_list$List$Nonempty$reverse = function (_n0) {
	var x = _n0.a;
	var xs = _n0.b;
	var revapp = function (_n1) {
		revapp:
		while (true) {
			var ls = _n1.a;
			var c = _n1.b;
...
var author$project$Snekk$move = F2(
	function (direction, snekk) {
		var head = mgold$elm_nonempty_list$List$Nonempty$head(snekk);
		...
		return A2(
			...
			mgold$elm_nonempty_list$List$Nonempty$fromElement(newHead),
			mgold$elm_nonempty_list$List$Nonempty$reverse(
				mgold$elm_nonempty_list$List$Nonempty$pop(
					mgold$elm_nonempty_list$List$Nonempty$reverse(snekk))));
	});
...
var author$project$Update$tick = F2(
	function (model, gameModel) {
		var newSnekk = A2(author$project$Snekk$move, gameModel.bi, gameModel.cg);
		var _n0 = author$project$Config$isOutOfBoundaries(
			mgold$elm_nonempty_list$List$Nonempty$head(newSnekk)) || A2(
			mgold$elm_nonempty_list$List$Nonempty$member,
			mgold$elm_nonempty_list$List$Nonempty$head(newSnekk),
			mgold$elm_nonempty_list$List$Nonempty$pop(newSnekk));
		if (_n0) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						bo: author$project$Model$GameOver(
							mgold$elm_nonempty_list$List$Nonempty$length(newSnekk) - 3),
						bp: (_Utils_cmp(
							mgold$elm_nonempty_list$List$Nonempty$length(newSnekk),
							model.bp) > 0) ? (mgold$elm_nonempty_list$List$Nonempty$length(newSnekk) - 3) : model.bp
					}),
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						bo: author$project$Model$Started(
							_Utils_update(
								gameModel,
								{
									bv: gameModel.bi,
									cg: _Utils_eq(
										...
										mgold$elm_nonempty_list$List$Nonempty$fromElement(
											mgold$elm_nonempty_list$List$Nonempty$head(
												mgold$elm_nonempty_list$List$Nonempty$reverse(newSnekk)))) : newSnekk
								}))
					}),
				_Utils_eq(
					mgold$elm_nonempty_list$List$Nonempty$head(newSnekk),
					gameModel.bm) ? author$project$Update$generateFood(model.bo) : elm$core$Platform$Cmd$none);
		}
	});
		...
		switch (msg.$) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bo: author$project$Model$Loading}),
					author$project$Update$generateFood(model.bo));
			case 1:
				var foodCoord = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							bo: author$project$Model$Started(
								A2(author$project$Update$setFood, model.bo, foodCoord))
						}),
					elm$core$Platform$Cmd$none);
			case 2:
				var _n1 = model.bo;
				if (_n1.$ === 2) {
					var gameModel = _n1.a;
					return A2(author$project$Update$tick, model, gameModel);
				} else {
				...
				if (_n2.$ === 2) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								bo: author$project$Model$Started(
									A2(author$project$Update$setDirection, direction, gameModel))
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = data.Z ? A2(Skinney$murmur3$Murmur3$mix, data.N, data.Z) : data.N;
	var h1 = acc ^ data.T;
...
var Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.Z | (c << data.ag);
		var _n0 = data.ag;
		if (_n0 === 24) {
			var newHash = Skinney$murmur3$Murmur3$step(
				A2(Skinney$murmur3$Murmur3$mix, data.N, res));
			return {T: data.T + 1, Z: 0, N: newHash, ag: 0};
		} else {
...
var rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bg: elm$core$Maybe$Nothing, br: _List_Nil, bx: _List_Nil, bK: snippets};
};
...
var rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_n0) {
	...
	var declarations = rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2(elm$core$List$concatMap, rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bg: charset, b_: declarations, br: imports, bx: namespaces};
};
...
var rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_n0) {
	...
	return {bg: charset, b_: finalDeclarations, br: imports, bx: namespaces};
};
...
var author$project$Styles$github = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
...
var rtfeldman$elm_css$Css$row = {aX: 0, at: 0, v: 'row'};
...
var author$project$Styles$layout = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
...
var author$project$Styles$grid = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$displayFlex,
			rtfeldman$elm_css$Css$flexDirection(rtfeldman$elm_css$Css$column),
...
var author$project$Styles$score = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$textAlign(rtfeldman$elm_css$Css$right)
		]));
var author$project$Styles$row = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[rtfeldman$elm_css$Css$displayFlex]));
...
var author$project$Styles$square = F2(
	function (isSnekk, isFood) {
		return rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					...
					isSnekk ? rtfeldman$elm_css$Css$hex('cccccc') : (isFood ? rtfeldman$elm_css$Css$hex('666666') : rtfeldman$elm_css$Css$hex('ffffff')))
				]));
	});
...
var author$project$View$square = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(mgold$elm_nonempty_list$List$Nonempty$member, coord, gameModel.cg),
					_Utils_eq(coord, gameModel.bm))
				]),
			_List_Nil);
	});
var author$project$View$row = F2(
	function (gameModel, y) {
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
			...
			A2(
				...
				A2(elm$core$List$range, 0, author$project$Config$gridSize)));
	});
...
var author$project$View$game = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									'Highest Score: ' + elm$core$String$fromInt(highestScore))
								])),
							A2(
							rtfeldman$elm_css$Html$Styled$div,
							_List_Nil,
							_List_fromArray(
								[
									...
									'Score: ' + elm$core$String$fromInt(
										mgold$elm_nonempty_list$List$Nonempty$length(gameModel.cg) - 3))
								]))
						])),
					A2(
					rtfeldman$elm_css$Html$Styled$div,
					...
					A2(
						elm$core$List$map,
						author$project$View$row(gameModel),
...
var rtfeldman$elm_css$Css$pointer = {a: 0, v: 'pointer'};
var author$project$Styles$button = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			A3(
			rtfeldman$elm_css$Css$border3,
...
var author$project$Styles$gameOver = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$displayFlex,
			rtfeldman$elm_css$Css$alignItems(rtfeldman$elm_css$Css$center),
...
var author$project$Styles$tryAgain = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
...
var author$project$View$gameOver = F2(
	function (highestScore, score) {
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[author$project$Styles$gameOver]),
			_List_fromArray(
				[
					A2(
					rtfeldman$elm_css$Html$Styled$div,
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text(
							'Game Over! Score: ' + (elm$core$String$fromInt(score) + (' Highest Score: ' + elm$core$String$fromInt(highestScore))))
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							author$project$Styles$tryAgain,
							rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Msg$StartGame)
						]),
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text('Try Again! (Or press Space)')
						]))
				]));
	});
...
var author$project$View$notStarted = A2(
	rtfeldman$elm_css$Html$Styled$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$text('Start Game! (Or press Space)')
				]))
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text('Snake Game in Elm')
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$a,
				_List_fromArray(
					[
						author$project$Styles$github,
						rtfeldman$elm_css$Html$Styled$Attributes$href('https://github.com/ryan-senn/elm-snekk'),
						rtfeldman$elm_css$Html$Styled$Attributes$target('_blank')
					]),
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text('Source Code on Github')
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						switch (_n0.$) {
							case 0:
								return author$project$View$notStarted;
							case 1:
								return author$project$View$loading;
							case 2:
								var gameModel = _n0.a;
								return A2(author$project$View$game, model.bp, gameModel);
							default:
								var score = _n0.a;
								return A2(author$project$View$gameOver, model.bp, score);
						}
					}()
					]))
			]));
