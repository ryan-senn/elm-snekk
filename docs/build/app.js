...
var _ryan_senn$snekk$Config$isOutOfBoundaries = function (coord) {
...
var _ryan_senn$snekk$Direction$fromKeyCode = function (keyCode) {
	var _p1 = keyCode;
	switch (_p1) {
		case 38:
...
var _ryan_senn$snekk$Snekk$move = F2(
	function (direction, snekk) {
		var head = _mgold$elm_nonempty_list$List_Nonempty$head(snekk);
		...
		return A2(
			...
			_mgold$elm_nonempty_list$List_Nonempty$fromElement(newHead),
			_mgold$elm_nonempty_list$List_Nonempty$reverse(
				_mgold$elm_nonempty_list$List_Nonempty$pop(
					_mgold$elm_nonempty_list$List_Nonempty$reverse(snekk))));
	});
...
var _ryan_senn$snekk$Model$initialGameModel = function (foodCoord) {
	return {snekk: _ryan_senn$snekk$Snekk$initialSnekk, lastTickDirection: _ryan_senn$snekk$Direction$East, desiredDirection: _ryan_senn$snekk$Direction$East, food: foodCoord};
};
...
var _ryan_senn$snekk$Msg$Tick = {ctor: 'Tick'};
var _ryan_senn$snekk$Msg$SetFood = function (a) {
	return {ctor: 'SetFood', _0: a};
};
var _ryan_senn$snekk$Msg$StartGamePress = function (a) {
	return {ctor: 'StartGamePress', _0: a};
};
var _ryan_senn$snekk$Msg$StartGame = {ctor: 'StartGame'};

var _ryan_senn$snekk$Update$setDirection = F2(
	function (keyCode, gameModel) {
		var _p0 = {
			ctor: '_Tuple2',
			_0: _ryan_senn$snekk$Direction$fromKeyCode(keyCode),
			_1: _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Maybe$Just(
					_ryan_senn$snekk$Direction$oppositeDirection(gameModel.lastTickDirection)),
				_ryan_senn$snekk$Direction$fromKeyCode(keyCode))
		};
		if (((_p0.ctor === '_Tuple2') && (_p0._0.ctor === 'Just')) && (_p0._1 === false)) {
			return _elm_lang$core$Native_Utils.update(
				gameModel,
				{desiredDirection: _p0._0._0});
		} else {
			return gameModel;
		}
	});
...
var _ryan_senn$snekk$Update$tick = F2(
	function (model, gameModel) {
		var newSnekk = A2(_ryan_senn$snekk$Snekk$move, gameModel.desiredDirection, gameModel.snekk);
		var _p6 = _ryan_senn$snekk$Config$isOutOfBoundaries(
		...
		if (_p6 === true) {
			...
			return A2(
					...
					}),
				{
					...
					_0: _elm_lang$core$Native_Utils.eq(
						_mgold$elm_nonempty_list$List_Nonempty$head(newSnekk),
						gameModel.food) ? _ryan_senn$snekk$Update$generateFood(model.gameState) : _elm_lang$core$Platform_Cmd$none,
					_1: {ctor: '[]'}
				});
		}
	});
var _ryan_senn$snekk$Update$setFood = F2(
	function (gameState, foodCoord) {
		...
		if (_p7.ctor === 'Started') {
			...
			return _ryan_senn$snekk$Model$initialGameModel(foodCoord);
		}
	});
			...
			case 'SetFood':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							gameState: _ryan_senn$snekk$Model$Started(
								A2(_ryan_senn$snekk$Update$setFood, model.gameState, _p8._0))
						}),
					{ctor: '[]'});
			case 'Tick':
				var _p10 = model.gameState;
				if (_p10.ctor === 'Started') {
					return A2(_ryan_senn$snekk$Update$tick, model, _p10._0);
				} else {
					return _elm_lang$core$Native_Utils.crashCase(
						'Update',
						{
							start: {line: 36, column: 13},
							end: {line: 41, column: 80}
						},
						_p10)('No ticks subscription if game is not started.');
				}
			default:
				...
				if (_p12.ctor === 'Started') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								gameState: _ryan_senn$snekk$Model$Started(
									A2(_ryan_senn$snekk$Update$setDirection, _p8._0, _p12._0))
							}),
						{ctor: '[]'});
				} else {
					return _elm_lang$core$Native_Utils.crashCase(
						'Update',
						{
							...
							end: {line: 49, column: 84}
						},
						_p12)('No direction subscription if game is not started.');
				}
		}
	});

var _ryan_senn$snekk$Styles$tryAgain = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _ryan_senn$snekk$Styles$gameOver = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _ryan_senn$snekk$Styles$square = F2(
					...
					_1: {
						...
						_1: {
							...
							_0: A3(
								...
								_rtfeldman$elm_css$Css$hex('efefef')),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$backgroundColor(
									isSnekk ? _rtfeldman$elm_css$Css$hex('cccccc') : (isFood ? _rtfeldman$elm_css$Css$hex('666666') : _rtfeldman$elm_css$Css$hex('ffffff'))),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _ryan_senn$snekk$Styles$row = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$displayFlex,
		_1: {ctor: '[]'}
	});
var _ryan_senn$snekk$Styles$score = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$textAlign(_rtfeldman$elm_css$Css$right),
		_1: {ctor: '[]'}
	});
var _ryan_senn$snekk$Styles$github = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _ryan_senn$snekk$Styles$grid = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$displayFlex,
		_1: {
...
var _ryan_senn$snekk$Styles$button = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A3(
			_rtfeldman$elm_css$Css$border3,
...
var _ryan_senn$snekk$Styles$layout = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$displayFlex,
		_1: {
...
var _ryan_senn$snekk$View$gameOver = F2(
	function (highestScore, score) {
		return A2(
			...
			{
				ctor: '::',
				_0: _ryan_senn$snekk$Styles$gameOver,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _ryan_senn$snekk$Styles$button,
							_1: {
								ctor: '::',
								_0: _ryan_senn$snekk$Styles$tryAgain,
								_1: {
									ctor: '::',
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('Try Again! (Or press Space)'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
	...
	function (gameModel, coord) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
				_0: A2(
					_ryan_senn$snekk$Styles$square,
					A2(_mgold$elm_nonempty_list$List_Nonempty$member, coord, gameModel.snekk),
					_elm_lang$core$Native_Utils.eq(coord, gameModel.food)),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'});
	});
var _ryan_senn$snekk$View$row = F2(
	function (gameModel, y) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
				_0: _ryan_senn$snekk$Styles$row,
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _ryan_senn$snekk$Styles$score,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _ryan_senn$snekk$View$notStarted = A2(
	_rtfeldman$elm_css$Html_Styled$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled$text('Start Game! (Or press Space)'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _ryan_senn$snekk$View$view = function (model) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _ryan_senn$snekk$Styles$layout,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled$text('Snake Game in Elm'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _ryan_senn$snekk$Styles$github,
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$href('https://github.com/ryan-senn/elm-snekk'),
							_1: {
								ctor: '::',
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text('Source Code on Github'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: function () {
								...
								switch (_p0.ctor) {
									case 'NotStarted':
										return _ryan_senn$snekk$View$notStarted;
									case 'Loading':
...
var _ryan_senn$snekk$Subs$startGame = function (gameState) {
	var _p0 = gameState;
	switch (_p0.ctor) {
		case 'NotStarted':
			return _elm_lang$keyboard$Keyboard$downs(_ryan_senn$snekk$Msg$StartGamePress);
		case 'GameOver':
			return _elm_lang$keyboard$Keyboard$downs(_ryan_senn$snekk$Msg$StartGamePress);
		default:
			return _elm_lang$core$Platform_Sub$none;
...
var _ryan_senn$snekk$Subs$setDirection = function (gameState) {
	var _p1 = gameState;
	if (_p1.ctor === 'Started') {
		return _elm_lang$keyboard$Keyboard$downs(_ryan_senn$snekk$Msg$SetDirection);
	} else {
		return _elm_lang$core$Platform_Sub$none;
	}
};
var _ryan_senn$snekk$Subs$ticks = function (gameState) {
	var _p2 = gameState;
	if (_p2.ctor === 'Started') {
		return A2(
			_elm_lang$core$Time$every,
...
var _ryan_senn$snekk$Subs$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _ryan_senn$snekk$Subs$ticks(model.gameState),
			_1: {
				ctor: '::',
				_0: _ryan_senn$snekk$Subs$setDirection(model.gameState),
				_1: {
					ctor: '::',
					_0: _ryan_senn$snekk$Subs$startGame(model.gameState),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _ryan_senn$snekk$Main$main = _elm_lang$html$Html$program(
	{
		init: A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_ryan_senn$snekk$Model$initialModel,
			{ctor: '[]'}),
		update: _ryan_senn$snekk$Update$update,
		subscriptions: _ryan_senn$snekk$Subs$subscriptions,
		view: function (_p0) {
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				_ryan_senn$snekk$View$view(_p0));
		}
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ryan_senn$snekk$Main$main !== 'undefined') {
    _ryan_senn$snekk$Main$main(Elm['Main'], 'Main', undefined);
}
